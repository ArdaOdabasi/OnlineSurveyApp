...
namespace OnlineSurveyApp.Infrastructure.Data
{
    public class OnlineSurveyDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            RulesForAnswerProperties(modelBuilder);
        ...
        private static void RulesForSurveyProperties(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Survey>().Property(s => s.CreationDate)
                                         .IsRequired();

            modelBuilder.Entity<Survey>().Property(s => s.Active)
                                         .IsRequired();

            modelBuilder.Entity<Survey>().Property(s => s.ConstituentId)
                                         .IsRequired();
        }
        ...
        private static void RulesForAnswerProperties(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Answer>().Property(a => a.SurveyId)
                                         .IsRequired();
